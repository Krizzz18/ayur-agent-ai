@echo off
REM AyurAgent AI - Quick Setup Script (Windows)
REM This script installs all Phase 2 dependencies and runs initial tests
...
REM Install Phase 2 testing dependencies
